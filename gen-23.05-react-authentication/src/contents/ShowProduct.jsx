      ...
      <main className='ml-48 p-4'>
        <div className='max-w-screen mx-auto'>
          <div className='container mx-auto mt-8'>
            ...
            <button className='bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-900 transition duration-200'>
                ...
                <tbody>
                  {products.map((product) => (
                    <tr key={product.id}>
                      ...
                      <td className='border px-4 py-2'>
                        <button className='bg-green-500 text-white px-2 py-1 rounded mr-2 hover:bg-green-900 transition duration-200'>
